...
Console.WriteLine("Номер строки с наименьшей суммой элементов: " + (indexLine) + ", сумма элементов равна: " + (minsum));
...
{
    Console.Write("Необходимо уменьшить размерность массива");
    return;
}
